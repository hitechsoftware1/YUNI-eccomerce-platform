      ...
      {slides.map((slide, index) => (
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white p-4">
            <h2 className="text-2xl font-bold font-headline md:text-5xl lg:text-6xl">
              {slide.title}
            </h2>
      ...
      {slides.length > 1 && (
        <>
          <Button
            ...
            size="icon"
            onClick={prevSlide}
            className="absolute left-4 top-1/2 -translate-y-1/2 rounded-full bg-white/20 text-white hover:bg-white/30 hover:text-white hidden md:inline-flex"
          >
          ...
          <Button
            ...
            size="icon"
            onClick={nextSlide}
            className="absolute right-4 top-1/2 -translate-y-1/2 rounded-full bg-white/20 text-white hover:bg-white/30 hover:text-white hidden md:inline-flex"
          >
